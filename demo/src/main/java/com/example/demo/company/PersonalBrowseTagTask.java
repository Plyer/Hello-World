...
public class PersonalBrowseTagTask {
	
	private static final Logger logger = Logger.getLogger(PersonalBrowseTagTask.class);
	private static final int DAYS = 30;
	
	public void run() {
		Thread t = new Thread(new Execute());
		t.start();
	}

	public static void main(String[] args) {
		String path = "/hadoopLog/" + "2018-04-11" + "/carDetail3-r-00000";
		Map<String, TreeMap<String, Integer>> map = new PersonalBrowseTagTask().new Execute().getTag(path, null);
		Set<Entry<String, TreeMap<String, Integer>>> entry = map.entrySet();
		for (Entry<String, TreeMap<String, Integer>> i : entry) {
